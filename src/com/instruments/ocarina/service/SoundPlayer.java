...
public class SoundPlayer {
	...
	private HashMap<String, Integer> loadAudioFiles() {
		...
		audioFiles.put("Fa#", audioPlayer.load(resourceGet.getResource(Uri.parse("android.resource://com.instruments.ocarina/raw/fa-sh")).getAbsolutePath(),1));
		...
		audioFiles.put("La#", audioPlayer.load(resourceGet.getResource(Uri.parse("android.resource://com.instruments.ocarina/raw/la-sh")).getAbsolutePath(),1));
		...
		audioFiles.put("So#", audioPlayer.load(resourceGet.getResource(Uri.parse("android.resource://com.instruments.ocarina/raw/so-sh")).getAbsolutePath(),1));
